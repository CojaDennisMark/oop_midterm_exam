...
public static class Examination
{
    ...
    static int RunTests()
    {
        ...
        // Assuming Enroll prevents duplicate enrollment
        ...
        score += AssertTrue(!student.Courses.Select(c => c.CourseName).Contains("OOP"), "Student courses should not include 'OOP'");
